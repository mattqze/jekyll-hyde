...
foreach (glob("_posts/*") as $post) {
  ...
  echo("<span class='post-meta'>".$postDate."</span><h3><a class='post-link' href='?post=".$location."'>".$postName."</a></h3></li></li>");
}
if(isset($_GET['post']))
{
  ob_clean();
  include('pkgs/Parsedown.php');
