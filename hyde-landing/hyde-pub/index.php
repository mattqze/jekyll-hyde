...
<body><header class="site-header">
  ...
  <div class="wrapper"><a class="site-title" rel="author" href="<?php echo($blogLocation); ?>"><?php echo($blogTitle.' - '.$instances[basename(__DIR__)][0]); ?></a><nav class="site-nav">
        ...
        <div class="trigger"><a class="page-link" href="/">Lander</a></div>
      </nav></div>
</header>
